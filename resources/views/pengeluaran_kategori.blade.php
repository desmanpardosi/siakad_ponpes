...
@section('title', __('Master Kategori Pengeluaran'))
@section('content')
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
          <form role="form" id="save" action="{{ route('master.pengeluaran.kategori.save') }}" method="post" enctype="multipart/form-data">
              @csrf
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-8">
                  <select class="form-control select2" style="width: 100%;" id="jenis" name="jenis">
                    ...
                    <option value="0">Dana Guru</option>
                    <option value="1">Dana Operasional</option>
                  </select>
                </div>
              </div>
              <div class="form-group row">
  ...
  <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <div class="modal-body">
              <form role="form" id="delete" action="{{ route('master.pengeluaran.kategori.delete') }}" method="post">
                  @csrf
                  @method('delete')
                  <input type="hidden" id="delete_id" name="delete_id">
              </form>
              <div>
                  <p>Anda yakin ingin menghapus <b><span id="delete_name" class="bolder"></span></b> dari daftar kategori pengeluaran?</p>
              </div>
          </div>
          <div class="modal-footer justify-content-between">
              <button type="button" class="btn btn-default" data-dismiss="modal">{{ __('Batal') }}</button>
...
<script>
  ...
  function editData(data) {
    ...
    $("#button-save").show();
    resetForm();
    $("#jenis").val(data.jenis_id).trigger("change");
