...
//Application Title
define('APP_TITLE', 'Primaya Hospital Bhakti Wara');
                ...
                <tr>
                    ...
                    <td data-sort=<?php echo fm_enc($f) ?>>
                        ...
                        <?php
                           ...
                           <?php else: ?>
                                <a href="<?php echo $file ?>" target="_blank" title="<?php echo $f ?>">
                            <?php endif; ?>
                    ...
                    <td class="inline-actions">
                        ...
                        <?php endif; ?>
                        <a title="<?php echo lng('Open') ?>" href="<?php echo fm_enc(FM_ROOT_URL . (FM_PATH != '' ? '/' . FM_PATH : '') . '/' . $f) ?>" target="_blank"><i class="fa fa-external-link-square"></i></a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <div class="col-xs-6 col-sm-7">
                <ul class="navbar-nav justify-content-end <?php echo fm_get_theme();  ?>">
                    ...
                    <li class="nav-item">
                        <a title="New Folder" class="nav-link" href="#createNewItem" data-bs-toggle="modal" data-bs-target="#createNewItem"><i class="fa fa-plus-square"></i> New Folder</a>
                    </li>
                    <?php endif; ?>
                    <?php if (FM_USE_AUTH): ?>
        ...
        <div class="modal-dialog" role="document">
            <form class="modal-content <?php echo fm_get_theme(); ?>" method="post">
                <div class="modal-header">
                    <h5 class="modal-title" id="newItemModalLabel"><i class="fa fa-plus-square fa-fw"></i>Create New Folder</h5>
                ...
                <div class="modal-body">
                    ...
                    <input type="text" name="newfilename" id="newfilename" value="" class="form-control" placeholder="Folder Name" required>
                </div>
